...
- include aggregate calculations without changing the output
- additional column
- group rows using PARTITION
- Window Functions allow to retain all row details, while Aggregate Functions collapse you rows in a groups
```sql
...
- RANK() 1, 2, 3, 3,3,3, 6,6, 8 - RANK jumps to overall position
- DENSE_RANK() 1,2,3, 4,4,4,4, 5,5,5, 6,7 - Don't jump
